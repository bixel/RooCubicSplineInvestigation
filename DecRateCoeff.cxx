...
DecRateCoeff::DecRateCoeff( const std::string& name, const std::string& title, CoeffType _coeff_type_,
                                  RooAbsCategory& _finalstate_, RooAbsReal& _cp_coeff_, RooAbsReal& _cp_coeff_bar_,
                                  RooAbsCategory& _tag_os_, RooAbsReal& _omegab_os_, RooAbsReal& _omegabbar_os_,
                                  RooAbsReal& _tageff_os_, RooAbsReal& _tageff_asym_os_, RooAbsCategory& _tag_ss_,
                                  RooAbsReal& _omegab_ss_, RooAbsReal& _omegabbar_ss_, RooAbsReal& _tageff_ss_,
...
DecRateCoeff::DecRateCoeff( const std::string& name, const std::string& title, CoeffType _coeff_type_,
                                  RooAbsCategory& _finalstate_, RooAbsReal& _cp_coeff_, RooAbsReal& _cp_coeff_bar_,
                                  RooAbsCategory& _tag_os_, RooAbsReal& _omegab_os_, RooAbsReal& _omegabbar_os_,
                                  RooAbsReal& _tageff_os_, RooAbsReal& _tageff_asym_os_, RooAbsReal& _production_asym_,
                                  RooAbsReal& _detection_asym_ )
    : RooAbsReal( name.c_str(), title.c_str() )
    , cp_coeff_( "cp_coeff_", "cp_coeff_", this, _cp_coeff_ )
    , cp_coeff_bar_( "cp_coeff_bar_", "cp_coeff_bar_", this, _cp_coeff_bar_ )
...
DecRateCoeff::DecRateCoeff( const std::string& name, const std::string& title, CoeffType _coeff_type_,
                                  RooAbsCategory& _finalstate_, RooAbsReal& _cp_coeff_, RooAbsReal& _cp_coeff_bar_,
                                  RooAbsCategory& _tag_os_, RooAbsReal& _eta_os_, RooAbsReal& _p0_os_,
                                  RooAbsReal& _p1_os_, RooAbsReal& _delta_p0_os_, RooAbsReal& _delta_p1_os_,
                                  RooAbsReal& _avg_eta_os_, RooAbsReal& _tageff_os_, RooAbsReal& _tageff_asym_os_,
                                  ...
                                  RooAbsReal& _avg_eta_ss_, RooAbsReal& _tageff_ss_, RooAbsReal& _tageff_asym_ss_,
                                  RooAbsReal& _production_asym_, RooAbsReal& _detection_asym_ )
    : RooAbsReal( name.c_str(), title.c_str() )
    , cp_coeff_( "cp_coeff_", "cp_coeff_", this, _cp_coeff_ )
    , cp_coeff_bar_( "cp_coeff_bar_", "cp_coeff_bar_", this, _cp_coeff_bar_ )
    , coeff_type_( _coeff_type_ )
...
Double_t DecRateCoeff::evaluate() const {
  return evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, finalstate_, tag_os_, omegab_os_, omegabbar_os_, eta_os_,
                   avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_, tag_ss_,
                   omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_, delta_p1_ss_,
                   tageff_ss_, tageff_asym_ss_, production_asym_, detection_asym_ );
}

Int_t DecRateCoeff::getAnalyticalIntegral( RooArgSet& allVars, RooArgSet& analVars,
...
Int_t DecRateCoeff::getAnalyticalIntegralWN( RooArgSet& allVars, RooArgSet& analVars, const RooArgSet* normSet,
                                                const char* /*rangeName*/ ) const {
  // debug
  // std::printf("CHECK: In %s line %u (%s): #Vars = %d : allVars = \n", __func__, __LINE__, __FILE__,
  // allVars.getSize()); allVars.Print();
...
Double_t DecRateCoeff::analyticalIntegral( Int_t code, const char* rangeName ) const {
  // debug
  ...
  if ( rangeName ) {
    ...
    if ( isTagInRange( tag_ss_, +1, rangeName ) ) {
      if ( isTagInRange( tag_os_, +1, rangeName ) ) {
        if ( isFinalstateInRange( finalstate_, +1, rangeName ) ) {
          integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, +1, +1, omegab_os_, omegabbar_os_, eta_os_,
                                avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_,
                                +1, omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_,
      ...
      if ( isTagInRange( tag_os_, 0, rangeName ) ) {
        if ( isFinalstateInRange( finalstate_, +1, rangeName ) ) {
          integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, +1, 0, omegab_os_, omegabbar_os_, eta_os_,
                                avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_,
                                +1, omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_,
                                delta_p1_ss_, tageff_ss_, tageff_asym_ss_, production_asym_, detection_asym_ );
        }
    ...
    if ( isTagInRange( tag_ss_, 0, rangeName ) ) {
      if ( isTagInRange( tag_os_, +1, rangeName ) ) {
        if ( isFinalstateInRange( finalstate_, +1, rangeName ) ) {
          integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, +1, +1, omegab_os_, omegabbar_os_, eta_os_,
                                avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_, 0,
                                omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_,
                                delta_p1_ss_, tageff_ss_, tageff_asym_ss_, production_asym_, detection_asym_ );
        }
        if ( isFinalstateInRange( finalstate_, -1, rangeName ) ) {
          integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, -1, +1, omegab_os_, omegabbar_os_, eta_os_,
    ...
    if ( code == 2 ) {
      double integral = 0.;
      if ( hasTagState( tag_os_, +1 ) && hasTagState( tag_ss_, +1 ) && hasFinalstateState( finalstate_, +1 ) )
        integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, +1, +1, omegab_os_, omegabbar_os_, eta_os_,
                              avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_, +1,
                              omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_,
                              delta_p1_ss_, tageff_ss_, tageff_asym_ss_, production_asym_, detection_asym_ );
      if ( hasTagState( tag_os_, +1 ) && hasTagState( tag_ss_, +1 ) && hasFinalstateState( finalstate_, -1 ) )
        integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, -1, +1, omegab_os_, omegabbar_os_, eta_os_,
      ...
      if ( hasTagState( tag_os_, +1 ) && hasTagState( tag_ss_, 0 ) && hasFinalstateState( finalstate_, +1 ) )
        integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, +1, +1, omegab_os_, omegabbar_os_, eta_os_,
                              avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_, 0,
                              omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_,
                              delta_p1_ss_, tageff_ss_, tageff_asym_ss_, production_asym_, detection_asym_ );
      ...
      if ( hasTagState( tag_os_, 0 ) && hasTagState( tag_ss_, +1 ) && hasFinalstateState( finalstate_, +1 ) )
        integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, +1, 0, omegab_os_, omegabbar_os_, eta_os_,
                              avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_, +1,
                              omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_,
                              delta_p1_ss_, tageff_ss_, tageff_asym_ss_, production_asym_, detection_asym_ );
      ...
      if ( hasTagState( tag_os_, 0 ) && hasTagState( tag_ss_, 0 ) && hasFinalstateState( finalstate_, +1 ) )
        integral += evaluate( cp_coeff_, cp_coeff_bar_, coeff_type_, +1, 0, omegab_os_, omegabbar_os_, eta_os_,
                              avg_eta_os_, p0_os_, p1_os_, delta_p0_os_, delta_p1_os_, tageff_os_, tageff_asym_os_, 0,
                              omegab_ss_, omegabbar_ss_, eta_ss_, avg_eta_ss_, p0_ss_, p1_ss_, delta_p0_ss_,
                              delta_p1_ss_, tageff_ss_, tageff_asym_ss_, production_asym_, detection_asym_ );
...
std::pair<double, double> DecRateCoeff::calibrate( double omegab, double omegabbar ) const {
...
std::pair<double, double> DecRateCoeff::calibrate( double eta, double avg_eta, double p0, double p1, double delta_p0,
...
Double_t DecRateCoeff::evaluate( double cp_coeff, double cp_coeff_bar, CoeffType coeff_type, int finalstate,
                                    int tag_os, double omegab_os, double omegabbar_os, double eta_os, double avg_eta_os,
                                    double p0_os, double p1_os, double delta_p0_os, double delta_p1_os,
                                    double tageff_os, double tageff_asym_os, int tag_ss, double omegab_ss,
                                    double omegabbar_ss, double eta_ss, double avg_eta_ss, double p0_ss, double p1_ss,
                                    double delta_p0_ss, double delta_p1_ss, double tageff_ss, double tageff_asym_ss,
                                    double production_asym, double detection_asym ) const {
  ...
  if ( onetagger_ ) {
    if ( coeff_type == kCos ) {
      if ( finalstate == 1 ) {
        if ( tag_os == 0 )
          ...
          return 1.0 * cp_coeff * ( 1 + detection_asym ) *
                 ( tag_os * tageff_os - 0.5 * tageff_asym_os -
                   production_asym *
                       ( tageff_os - 0.5 * tag_os * tageff_asym_os - tag_os * tageff_os * ( eta_os_b - eta_os_bbar ) +
        ...
        std::cout << "ERROR\t"
                  << "DecRateCoeff::evaluate(...): No valid finalstate!" << std::endl;
        abort();
      }
    }
    if ( coeff_type == kSin ) {
          ...
          return 1.0 * cp_coeff * ( 1 + detection_asym ) *
                 ( tageff_os - 0.5 * tag_os * tageff_asym_os -
                   tag_os * production_asym *
                       ( tageff_os - 0.5 * tag_os * tageff_asym_os - tageff_os * ( eta_os_b + eta_os_bbar ) +
  ...
  if ( tag_os == 0 && tag_ss == 0 ) {
    sum = ( 1 - tageff_os_b - tageff_ss_b + tageff_os_b * tageff_ss_b ) +
          ( 1 - tageff_os_bbar - tageff_ss_bbar + tageff_os_bbar * tageff_ss_bbar );
    difference = ( 1 - tageff_os_b - tageff_ss_b + tageff_os_b * tageff_ss_b ) -
                 ( 1 - tageff_os_bbar - tageff_ss_bbar + tageff_os_bbar * tageff_ss_bbar );
  } else if ( tag_os == 0 && tag_ss != 0 ) {
    sum = 0.5 * tageff_ss_b *
              ( 1 - tageff_os_b + tag_ss * ( 1 - tageff_os_b - 2 * eta_ss_b + 2 * eta_ss_b * tageff_os_b ) ) +
          0.5 * tageff_ss_bbar *
              ( 1 - tageff_os_bbar -
                tag_ss * ( 1 - tageff_os_bbar - 2 * eta_ss_bbar + 2 * eta_ss_bbar * tageff_os_bbar ) );
    ...
    sum = 0.5 * tageff_os_b *
              ( 1 - tageff_ss_b + tag_os * ( 1 - tageff_ss_b - 2 * eta_os_b + 2 * eta_os_b * tageff_ss_b ) ) +
          0.5 * tageff_os_bbar *
              ( 1 - tageff_ss_bbar -
                tag_os * ( 1 - tageff_ss_bbar - 2 * eta_os_bbar + 2 * eta_os_bbar * tageff_ss_bbar ) );
    ...
    sum = 0.25 * tageff_os_b * tageff_ss_b *
          ...
          0.25 * tageff_os_bbar * tageff_ss_bbar *
              ( 1 - tag_ss * ( 1 - 2 * eta_ss_bbar ) - tag_os * ( 1 - 2 * eta_os_bbar ) +
                tag_os * tag_ss * ( 1 - 2 * eta_os_bbar - 2 * eta_ss_bbar + 4 * eta_os_bbar * eta_ss_bbar ) );
    difference = 0.25 * tageff_os_b * tageff_ss_b *
                     ( 1 + tag_ss * ( 1 - 2 * eta_ss_b ) + tag_os * ( 1 - 2 * eta_os_b ) +
                       tag_os * tag_ss * ( 1 - 2 * eta_os_b - 2 * eta_ss_b + 4 * eta_os_b * eta_ss_b ) ) -
                 0.25 * tageff_os_bbar * tageff_ss_bbar *
                     ( 1 - tag_ss * ( 1 - 2 * eta_ss_bbar ) - tag_os * ( 1 - 2 * eta_os_bbar ) +
    ...
    std::cout << "ERROR\t"
              << "DecRateCoeff::evaluate(...): No valid tag combination!" << std::endl;
    abort();
  }
  ...
  if ( coeff_type == kSin ) {
    ...
    std::cout << "ERROR\t"
              << "DecRateCoeff::evaluate(...): No valid coefficient type!" << std::endl;
    abort();
  }
}

bool DecRateCoeff::isTagInRange( const RooCategoryProxy& tag, int tag_state, const char* rangeName ) const {
  if ( tag.arg().lookupType( tag_state ) == nullptr ) {
    return false;
  } else {
    return dynamic_cast<const RooCategory&>( tag.arg() )
        .isStateInRange( rangeName, tag.arg().lookupType( tag_state )->GetName() );
  }
}

bool DecRateCoeff::hasTagState( const RooCategoryProxy& tag, int tag_state ) const {
  return dynamic_cast<const RooCategory&>( tag.arg() ).isValidIndex( tag_state );
}

bool DecRateCoeff::isFinalstateInRange( const RooCategoryProxy& finalstate, int finalstate_state,
                                           const char* rangeName ) const {
  if ( finalstate.arg().lookupType( finalstate_state ) == nullptr ) {
    return false;
  } else {
    return dynamic_cast<const RooCategory&>( finalstate.arg() )
        .isStateInRange( rangeName, finalstate.arg().lookupType( finalstate_state )->GetName() );
  }
}

bool DecRateCoeff::hasFinalstateState( const RooCategoryProxy& finalstate, int finalstate_state ) const {
